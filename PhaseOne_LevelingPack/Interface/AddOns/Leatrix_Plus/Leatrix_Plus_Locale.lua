...
L["Drag to set the font size of book text.\n\nReading books, not spellbook"] = "拖动以调整文本字体的大小。"
...
L["Drag to set the font size of book text.\n\nReading books, not spellbook"] = "拖拉來設定書籍文字大小。"
...
L["Automate gossip"] = "NPC Диалоги: авто"
...
L["Block party invites"] = "Блок пригл. в группу"
L["Block shared quests"] = "Блок предл. квестов"
...
L["Class colored frames"] = "Фреймы: цвет класса"
...
L["Disable bag automation"] = "Не открывать сумку"
L["Also disables confirmation popup when you try to loot BOP item."] = "Автоматический лут BOP айтемов, без окна подтверждения."
L["Disable chat fade"] = "Чат не исчезай"
L["Disable loot warnings"] = "Отключить предупреждения о добыче"
L["Disable screen effects"] = "Откл. экран смерти"
...
L["Drag to set the font size of book text.\n\nReading books, not spellbook"] = "Переместите ползунок влево или вправо, чтобы установить размер шрифта текста книги."
...
L["Enhance dressup"] = "Улучш. примерочную"
L["Enhance minimap"] = "Улучшить миникарту"
L["Enhance professions"] = "Улучш. профессии"
L["Enhance quest log"] = "Улучш. журн. заданий"
L["Enhance tooltip"] = "Улучшить подсказки"
L["Enhance trainers"] = "Улучш. окно тренера"
...
L["Faster movie skip"] = "Пропуск роликов"
...
L["Filter chat messages"] = "Фильтр чата, спам"
...
L["Hide error messages"] = "Скр. красный текст"
L["Hide gryphons"] = "Скрыть грифонов"
L["Hide keybind text"] = "Скрыть текст кнопок"
L["Hide macro text"] = "Скрыть текст макроса"
L["Hide portrait numbers"] = "Скр. числа в портрете"
...
L["Increase chat history"] = "Длинная история"
...
L["Manage durability"] = "Управл. прочностью"
L["Manage focus"] = "Управление фокусом"
L["Manage frames"] = "Управл. юнитфреймы"
L["Manage timer"] = "Управление таймером"
L["Manage widget"] = "Управл. виджетами"
...
L["Resize book text"] = "Размер текста книг"
...
L["Restore chat messages"] = "Восст. истории чата"
...
L["Set weather density"] = "Плотность погоды"
...
L["Show auction controls"] = "Улучшить аукцыон"
L["Show background"] = "Показать фон"
L["Show bag search box"] = "Сумка: строка поиска"
...
L["Show durability status"] = "Прочность айтемов"
L["Show flight times"] = "Время полётов"
...
L["Show player chain"] = "Рамка элиты"
...
L["Toggle helm / cloak"] = "Шлем / плащ - перекл."
...
L["Silence rested emotes"] = "Выкл. звуки эмоций"
L["Silithus"] = "Силитус"
...
L["Universal group color"] = "Рейд чат - синий"
L["Unlock the minimap"] = "Разблокировать миникарту"
L["Use arrow keys in chat"] = "Юзай стрелки в чате"
L["Use class colors in chat"] = "Имена в цвете класса"
L["Use easy resizing"] = "Тяни вкладку чата"
...
L["Drag to set the font size of book text.\n\nReading books, not spellbook"] = "책 텍스트의 글꼴 크기를 설정하려면 드래그하십시오."
...
L["Toggle helm / cloak"] = "투구,망토 설정 표시"
...
L["Drag to set the font size of book text.\n\nReading books, not spellbook"] = "Arrastra para establecer el tamaño de fuente del texto de libro."
...
L["Drag to set the font size of book text.\n\nReading books, not spellbook"] = "Faites glisser pour définir la taille de police du texte du livre."
...
L["Toggle helm / cloak"] = "Afficher les commandes de vanité"
...
L["Drag to set the font size of book text.\n\nReading books, not spellbook"] = "Arraste para definir o tamanho da fonte do texto do livro."
...
L["Toggle helm / cloak"] = "Personalizados"
...
L["Drag to set the font size of book text.\n\nReading books, not spellbook"] = "Ziehen, um die Schriftgröße des Buchtexts festzulegen. "
...
if GameLocale == "ruRU" then
    ...
    L["Azuremyst (Exodar)"]                    = "Остров Лазурной Дымки (Экзодар)"
    L["Black Temple (Extra)"]                   = "Черный Храм (Доп.)"
    L["Blade's Edge (Ogres)"]                         = "Острогорье (Огры)"
    L["Bloodmyst (Naga)"]                           = "Остров Кровавой Дымки (Наги)"
    L["Borean Tundra (Riplash)"]                     = "Борейская тундра (Риплаш)"
    L["Caverns of Time (Extra)"]                      = "Пещеры Времени (Доп.)"
    L["Darnassus (Druid Grove)"]                      = "Дарнас (Роща Друидов)"
    L["Dragonblight (Intro)"]                         = "Драконий Погост (Интро)"
    L["Ebon Hold"]                                    = "Черный Оплот"
    L["Eversong (Scenic/Scorched)"]                   = "Леса Вечной Песни (Пейзажи/Пожарища)"
    L["Ghostlands (Scenic)"]                          = "Призрачные земли (Пейзажи)"
    L["GhostMusic"]                                  = "Призрачная музыка"
    L["Grizzly Hills (Intros)"]                       = "Седые холмы (Интро)"
    L["Hellfire (Extra)"]                             = "П-ов Адского Пламени (Доп.)"
    L["Icecrown (Intros)"]                            = "Ледяная Корона (Интро)"
    L["Iron Dwarf (Northrend)"]               = "Железные Дворфы (Нордскол)" -- Key matches the Zn call's 3rd arg
    L["Ironforge (Extra)"]                            = "Стальгорн (Доп.)"
    L["Moments (Guld/Titans)"]                    = "Моменты (Гул'дан/Титаны)" -- Key matches the Zn call's 3rd arg
    L["Nagrand (Diamond)"]                      = "Награнд (Алмаз. гора)" -- Key matches the Zn call's 3rd arg
    L["Netherstorm (Plant Intros)"]                   = "Пустоверть (Интро растений)"
    L["Northrend Transport"]                          = "Транспорт Нордскола"
    L["Northrend Orc Themes"]                         = "Темы Орков Нордскола"
    L["Orgrimmar (Moments)"]                          = "Оргриммар (Моменты)"
    L["Outland (Action/Corrupt)"]           = "Запределье (Экшен/Искажение)" -- Key matches the Zn call's 3rd arg
    L["Sholazar (Lifeblood Cave)"]                    = "Шолазар (Пещера Жизни)"
    L["Stormwind (High Seas)"]                        = "Штормград (Открытое море)"
    L["Sunwell Plateau (Extra)"]                      = "Солнечный Колодец (Доп.)" -- Key matches Zn's 3rd arg; translation from your L["Sunwell (Extra)"]
    L["Taunka (Northrend)"]                    = "Таунка (Нордскол)" -- Key matches the Zn call's 3rd arg
    L["Various Taverns"]                              = "Разные таверны"
    L["Tempest Keep (Extra)"]                         = "Крепость Бурь (Доп.)"
    L["Terokkar (Shattrath/Auch.)"]                   = "Лес Тероккар (Шаттрат/Аукиндон)"
    L["Northrend Troll Themes"]                       = "Темы Троллей Нордскола"
    L["Violet Hold"]                                  = "Аметистовая Крепость"
    L["Events (Fire Festival)"]                       = "События (Огненный Солнцеворот)"
    L["L70ETC Tracks"]                                = "Треки L70ETC"
    L["Zul'Aman (Battle/Victory)"]                    = "Зул'Аман (Битва/Победа)"

    -- Потенциальные будущие ключи (для реорганизации таверн, если еще не добавлены)
    L["Dwarf Taverns"] = "Таверны Дворфов"
    L["Human Taverns"] = "Таверны Людей"
    L["Night Elf Taverns"] = "Таверны Н. Эльфов"
    L["Orc Taverns"] = "Таверны Орков"
    L["Pirate Taverns"] = "Пиратские Таверны"
    L["Tauren Taverns"] = "Таверны Тауренов"
    L["Undead Taverns"] = "Таверны Нежити"
    L["L70ETC Concert"] = "Концерт L70ETC"
    L["Darkmoon Faire (L70ETC)"] = "Ярмарка Новолуния (L70ETC)"
    L["Spooky Ambience"] = "Жуткая атмосфера"
end
...
if GameLocale == "deDE" then
    ...
    L["Black Temple (Extra)"]                   = "Schwarzer Tempel (Extra)"
    L["Blade's Edge (Ogres)"]                         = "Schergrat (Oger)"
    L["Bloodmyst (Naga)"]                           = "Blutmythos (Naga)"
    L["Borean Tundra (Riplash)"]                     = "Boreanische Tundra (Peitschennarbe)"
    L["Caverns of Time (Extra)"]                      = "Höhlen der Zeit (Extra)"
    L["Darnassus (Druid Grove)"]                      = "Darnassus (Druidenhain)"
    L["Dragonblight (Intro)"]                         = "Drachenöde (Intro)"
    L["Ebon Hold"]                                    = "Schwarze Festung"
    L["Eversong (Scenic/Scorched)"]                   = "Immersangwald (Malerisch/Verbrannt)"
    L["Ghostlands (Scenic)"]                          = "Geisterlande (Malerisch)"
    L["GhostMusic"]                                  = "Geistermusik"
    L["Grizzly Hills (Intros)"]                       = "Grizzlyhügel (Intros)"
    L["Hellfire (Extra)"]                             = "Höllenfeuerhalbinsel (Extra)"
    L["Icecrown (Intros)"]                            = "Eiskrone (Intros)"
    L["Iron Dwarf (Northrend)"]               = "Eisenzwerge (Nordend)"
    L["Ironforge (Extra)"]                            = "Eisenschmiede (Extra)"
    L["Moments (Guld/Titans)"]                    = "Momente (Gul'dan/Titanen)"
    L["Nagrand (Diamond)"]                      = "Nagrand (Diamant)"
    L["Netherstorm (Plant Intros)"]                   = "Nethersturm (Pflanzen-Intros)"
    L["Northrend Transport"]                          = "Nordend Transport"
    L["Northrend Orc Themes"]                         = "Nordend Orc-Themen"
    L["Orgrimmar (Moments)"]                          = "Orgrimmar (Momente)"
    L["Outland (Action/Corrupt)"]           = "Scherbenwelt (Action/Verdorben)"
    L["Sholazar (Lifeblood Cave)"]                    = "Sholazarbecken (Lebensbluthöhle)"
    L["Stormwind (High Seas)"]                        = "Sturmwind (Hohe See)"
    L["Sunwell Plateau (Extra)"]                      = "Sonnenbrunnenplateau (Extra)"
    L["Taunka (Northrend)"]                    = "Taunka (Nordend)"
    L["Various Taverns"]                              = "Verschiedene Tavernen"
    L["Tempest Keep (Extra)"]                         = "Festung der Stürme (Extra)"
    L["Terokkar (Shattrath/Auch.)"]                   = "Wälder von Terokkar (Shattrath/Auchindoun)"
    L["Northrend Troll Themes"]                       = "Nordend Troll-Themen"
    L["Violet Hold"]                                  = "Violette Festung"
    L["Events (Fire Festival)"]                       = "Events (Sonnenwendfest)"
    L["L70ETC Tracks"]                                = "L70ETC Lieder"
    L["Zul'Aman (Battle/Victory)"]                    = "Zul'Aman (Kampf/Sieg)"
end
...
if GameLocale == "frFR" then
    ...
    L["Black Temple (Extra)"]                   = "Temple Noir (Extra)"
    L["Blade's Edge (Ogres)"]                         = "Les Tranchantes (Ogres)"
    L["Bloodmyst (Naga)"]                           = "Île de Brume-sang (Nagas)"
    L["Borean Tundra (Riplash)"]                     = "Toundra Boréenne (Riplash)"
    L["Caverns of Time (Extra)"]                      = "Cavernes du Temps (Extra)"
    L["Darnassus (Druid Grove)"]                      = "Darnassus (Bosquet des Druides)"
    L["Dragonblight (Intro)"]                         = "Désolation des dragons (Intro)"
    L["Ebon Hold"]                                    = "Fort d'Ébène"
    L["Eversong (Scenic/Scorched)"]                   = "Bois des Chants éternels (Pittoresque/Brûlé)"
    L["Ghostlands (Scenic)"]                          = "Terres fantômes (Pittoresque)"
    L["GhostMusic"]                                  = "Musique spectrale"
    L["Grizzly Hills (Intros)"]                       = "Les Grisonnes (Intros)"
    L["Hellfire (Extra)"]                             = "Péninsule des Flammes infernales (Extra)"
    L["Icecrown (Intros)"]                            = "La Couronne de glace (Intros)"
    L["Iron Dwarf (Northrend)"]               = "Nains de Fer (Norfendre)"
    L["Ironforge (Extra)"]                            = "Forgefer (Extra)"
    L["Moments (Guld/Titans)"]                    = "Moments (Gul'dan/Titans)"
    L["Nagrand (Diamond)"]                      = "Nagrand (Diamant)"
    L["Netherstorm (Plant Intros)"]                   = "Raz-de-Néant (Intros Plantes)"
    L["Northrend Transport"]                          = "Transport Norfendre"
    L["Northrend Orc Themes"]                         = "Thèmes Orcs Norfendre"
    L["Orgrimmar (Moments)"]                          = "Orgrimmar (Moments)"
    L["Outland (Action/Corrupt)"]           = "Outreterre (Action/Corrompu)"
    L["Sholazar (Lifeblood Cave)"]                    = "Bassin de Sholazar (Grotte Sang-de-vie)"
    L["Stormwind (High Seas)"]                        = "Hurlevent (Haute Mer)"
    L["Sunwell Plateau (Extra)"]                      = "Plateau du Puits de soleil (Extra)"
    L["Taunka (Northrend)"]                    = "Taunkas (Norfendre)"
    L["Various Taverns"]                              = "Tavernes diverses"
    L["Tempest Keep (Extra)"]                         = "Donjon de la Tempête (Extra)"
    L["Terokkar (Shattrath/Auch.)"]                   = "Forêt de Terokkar (Shattrath/Auchindoun)"
    L["Northrend Troll Themes"]                       = "Thèmes Trolls Norfendre"
    L["Violet Hold"]                                  = "Fort Pourpre"
    L["Events (Fire Festival)"]                       = "Événements (Festival du Feu)"
    L["L70ETC Tracks"]                                = "Pistes L70ETC"
    L["Zul'Aman (Battle/Victory)"]                    = "Zul'Aman (Combat/Victoire)"
end
...
if GameLocale == "esES" or GameLocale == "esMX" then
    ...
    L["Black Temple (Extra)"]                   = "Templo Oscuro (Extra)"
    L["Blade's Edge (Ogres)"]                         = "Montañas Filospada (Ogros)"
    L["Bloodmyst (Naga)"]                           = "Isla Bruma de Sangre (Naga)"
    L["Borean Tundra (Riplash)"]                     = "Tundra Boreal (Ves Chicah)"
    L["Caverns of Time (Extra)"]                      = "Cavernas del Tiempo (Extra)"
    L["Darnassus (Druid Grove)"]                      = "Darnassus (Claro de los Druidas)"
    L["Dragonblight (Intro)"]                         = "Cementerio de Dragones (Intro)"
    L["Ebon Hold"]                                    = "Bastión de Ébano"
    L["Eversong (Scenic/Scorched)"]                   = "Bosque Canción Eterna (Paisajes/Quemado)"
    L["Ghostlands (Scenic)"]                          = "Tierras Fantasma (Paisajes)"
    L["GhostMusic"]                                  = "Música espectral"
    L["Grizzly Hills (Intros)"]                       = "Colinas Pardas (Intros)"
    L["Hellfire (Extra)"]                             = "Península del Fuego Infernal (Extra)"
    L["Icecrown (Intros)"]                            = "Corona de Hielo (Intros)"
    L["Iron Dwarf (Northrend)"]               = "Enanos Férreos (Rasganorte)"
    L["Ironforge (Extra)"]                            = "Forjaz (Extra)"
    L["Moments (Guld/Titans)"]                    = "Momentos (Gul'dan/Titanes)"
    L["Nagrand (Diamond)"]                      = "Nagrand (Diamante)"
    L["Netherstorm (Plant Intros)"]                   = "Tormenta Abisal (Intros Plantas)"
    L["Northrend Transport"]                          = "Transporte Rasganorte"
    L["Northrend Orc Themes"]                         = "Temas Orcos Rasganorte"
    L["Orgrimmar (Moments)"]                          = "Orgrimmar (Momentos)"
    L["Outland (Action/Corrupt)"]           = "Terrallende (Acción/Corrupto)"
    L["Sholazar (Lifeblood Cave)"]                    = "Cuenca de Sholazar (Cueva Sangrevida)"
    L["Stormwind (High Seas)"]                        = "Ventormenta (Alta Mar)"
    L["Sunwell Plateau (Extra)"]                      = "Meseta de La Fuente del Sol (Extra)"
    L["Taunka (Northrend)"]                    = "Taunka (Rasganorte)"
    L["Various Taverns"]                              = "Tabernas Varias"
    L["Tempest Keep (Extra)"]                         = "Castillo de la Tempestad (Extra)"
    L["Terokkar (Shattrath/Auch.)"]                   = "Bosque de Terokkar (Shattrath/Auchindoun)"
    L["Northrend Troll Themes"]                       = "Temas Trols Rasganorte"
    L["Violet Hold"]                                  = "Bastión Violeta"
    L["Events (Fire Festival)"]                       = "Eventos (Festival del Fuego)"
    L["L70ETC Tracks"]                                = "Pistas L70ETC"
    L["Zul'Aman (Battle/Victory)"]                    = "Zul'Aman (Batalla/Victoria)"
end
...
if GameLocale == "koKR" then
    ...
    L["Black Temple (Extra)"]                   = "검은 사원 (추가)"
    L["Blade's Edge (Ogres)"]                         = "칼날 산맥 (오우거)"
    L["Bloodmyst (Naga)"]                           = "핏빛안개 섬 (나가)"
    L["Borean Tundra (Riplash)"]                     = "북풍의 땅 (파도의 제단)"
    L["Caverns of Time (Extra)"]                      = "시간의 동굴 (추가)"
    L["Darnassus (Druid Grove)"]                      = "다르나서스 (드루이드 숲)"
    L["Dragonblight (Intro)"]                         = "용의 안식처 (인트로)"
    L["Ebon Hold"]                                    = "칠흑의 요새"
    L["Eversong (Scenic/Scorched)"]                   = "영원노래 숲 (풍경/불탄 곳)"
    L["Ghostlands (Scenic)"]                          = "유령의 땅 (풍경)"
    L["GhostMusic"]                                  = "유령 음악"
    L["Grizzly Hills (Intros)"]                       = "회색 구릉지 (인트로)"
    L["Hellfire (Extra)"]                             = "지옥불 반도 (추가)"
    L["Icecrown (Intros)"]                            = "얼음왕관 (인트로)"
    L["Iron Dwarf (Northrend)"]               = "강철 드워프 (노스렌드)"
    L["Ironforge (Extra)"]                            = "아이언포지 (추가)"
    L["Moments (Guld/Titans)"]                    = "순간들 (굴단/티탄)"
    L["Nagrand (Diamond)"]                      = "나그란드 (다이아몬드)"
    L["Netherstorm (Plant Intros)"]                   = "황천의 폭풍 (식물 인트로)"
    L["Northrend Transport"]                          = "노스렌드 수송"
    L["Northrend Orc Themes"]                         = "노스렌드 오크 테마"
    L["Orgrimmar (Moments)"]                          = "오그리마 (순간들)"
    L["Outland (Action/Corrupt)"]           = "아웃랜드 (액션/타락)"
    L["Sholazar (Lifeblood Cave)"]                    = "숄라자르 분지 (생명의 혈맥 동굴)"
    L["Stormwind (High Seas)"]                        = "스톰윈드 (넓은 바다)"
    L["Sunwell Plateau (Extra)"]                      = "태양샘 고원 (추가)"
    L["Taunka (Northrend)"]                    = "타운카 (노스렌드)"
    L["Various Taverns"]                              = "다양한 선술집"
    L["Tempest Keep (Extra)"]                         = "폭풍우 요새 (추가)"
    L["Terokkar (Shattrath/Auch.)"]                   = "테로카르 숲 (샤트라스/아킨둔)"
    L["Northrend Troll Themes"]                       = "노스렌드 트롤 테마"
    L["Violet Hold"]                                  = "보랏빛 요새"
    L["Events (Fire Festival)"]                       = "이벤트 (불꽃 축제)"
    L["L70ETC Tracks"]                                = "L70ETC 트랙"
    L["Zul'Aman (Battle/Victory)"]                    = "줄아만 (전투/승리)"
end
...
if GameLocale == "zhCN" then
    ...
    L["Black Temple (Extra)"]                   = "黑暗神殿 (额外)"
    L["Blade's Edge (Ogres)"]                         = "刀锋山 (食人魔)"
    L["Bloodmyst (Naga)"]                           = "秘血岛 (纳迦)"
    L["Borean Tundra (Riplash)"]                     = "北风苔原 (裂鞭废墟)"
    L["Caverns of Time (Extra)"]                      = "时光之穴 (额外)"
    L["Darnassus (Druid Grove)"]                      = "达纳苏斯 (德鲁伊林地)"
    L["Dragonblight (Intro)"]                         = "龙骨荒野 (前奏)"
    L["Ebon Hold"]                                    = "黑锋要塞"
    L["Eversong (Scenic/Scorched)"]                   = "永歌森林 (风景/焦土)"
    L["Ghostlands (Scenic)"]                          = "幽魂之地 (风景)"
    L["GhostMusic"]                                  = "幽灵音乐"
    L["Grizzly Hills (Intros)"]                       = "灰熊丘陵 (前奏)"
    L["Hellfire (Extra)"]                             = "地狱火半岛 (额外)"
    L["Icecrown (Intros)"]                            = "冰冠冰川 (前奏)"
    L["Iron Dwarf (Northrend)"]               = "铁矮人 (诺森德)"
    L["Ironforge (Extra)"]                            = "铁炉堡 (额外)"
    L["Moments (Guld/Titans)"]                    = "时刻 (古尔丹/泰坦)"
    L["Nagrand (Diamond)"]                      = "纳格兰 (钻石山)"
    L["Netherstorm (Plant Intros)"]                   = "虚空风暴 (植物前奏)"
    L["Northrend Transport"]                          = "诺森德运输"
    L["Northrend Orc Themes"]                         = "诺森德兽人主题"
    L["Orgrimmar (Moments)"]                          = "奥格瑞玛 (时刻)"
    L["Outland (Action/Corrupt)"]           = "外域 (动作/腐化)"
    L["Sholazar (Lifeblood Cave)"]                    = "索拉查盆地 (生命之血洞穴)"
    L["Stormwind (High Seas)"]                        = "暴风城 (远洋)"
    L["Sunwell Plateau (Extra)"]                      = "太阳之井高地 (额外)"
    L["Taunka (Northrend)"]                    = "牦牛人 (诺森德)"
    L["Various Taverns"]                              = "各地旅店"
    L["Tempest Keep (Extra)"]                         = "风暴要塞 (额外)"
    L["Terokkar (Shattrath/Auch.)"]                   = "泰罗卡森林 (沙塔斯/奥金顿)"
    L["Northrend Troll Themes"]                       = "诺森德巨魔主题"
    L["Violet Hold"]                                  = "紫罗兰监狱"
    L["Events (Fire Festival)"]                       = "事件 (火焰节)"
    L["L70ETC Tracks"]                                = "70级精英牛头人酋长曲目"
    L["Zul'Aman (Battle/Victory)"]                    = "祖阿曼 (战斗/胜利)"
end
...
if GameLocale == "zhTW" then
    ...
    L["Black Temple (Extra)"]                   = "黑暗神廟 (額外)"
    L["Blade's Edge (Ogres)"]                         = "劍刃山脈 (食人魔)"
    L["Bloodmyst (Naga)"]                           = "血謎島 (納迦)"
    L["Borean Tundra (Riplash)"]                     = "北風凍原 (裂鞭廢墟)"
    L["Caverns of Time (Extra)"]                      = "時光之穴 (額外)"
    L["Darnassus (Druid Grove)"]                      = "達納蘇斯 (德魯伊林地)"
    L["Dragonblight (Intro)"]                         = "龍骨荒野 (序曲)"
    L["Ebon Hold"]                                    = "黯刃堡"
    L["Eversong (Scenic/Scorched)"]                   = "永歌森林 (風景/焦土)"
    L["Ghostlands (Scenic)"]                          = "鬼魂之地 (風景)"
    L["GhostMusic"]                                  = "鬼魅音樂"
    L["Grizzly Hills (Intros)"]                       = "灰白之丘 (序曲)"
    L["Hellfire (Extra)"]                             = "地獄火半島 (額外)"
    L["Icecrown (Intros)"]                            = "寒冰皇冠 (序曲)"
    L["Iron Dwarf (Northrend)"]               = "鋼鐵矮人 (北裂境)"
    L["Ironforge (Extra)"]                            = "鐵爐堡 (額外)"
    L["Moments (Guld/Titans)"]                    = "時刻 (古爾丹/泰坦)"
    L["Nagrand (Diamond)"]                      = "納葛蘭 (鑽石山)"
    L["Netherstorm (Plant Intros)"]                   = "虛空風暴 (植物序曲)"
    L["Northrend Transport"]                          = "北裂境運輸"
    L["Northrend Orc Themes"]                         = "北裂境獸人主題"
    L["Orgrimmar (Moments)"]                          = "奧格瑪 (時刻)"
    L["Outland (Action/Corrupt)"]           = "外域 (動作/腐化)"
    L["Sholazar (Lifeblood Cave)"]                    = "休拉薩盆地 (生命之血洞穴)"
    L["Stormwind (High Seas)"]                        = "暴風城 (公海)"
    L["Sunwell Plateau (Extra)"]                      = "太陽之井高地 (額外)"
    L["Taunka (Northrend)"]                    = "坦卡 (北裂境)"
    L["Various Taverns"]                              = "各地旅店"
    L["Tempest Keep (Extra)"]                         = "風暴要塞 (額外)"
    L["Terokkar (Shattrath/Auch.)"]                   = "泰洛卡森林 (撒塔斯城/奧奇頓)" -- Corrected Auchindoun translation
    L["Northrend Troll Themes"]                       = "北裂境食人妖主題"
    L["Violet Hold"]                                  = "紫羅蘭堡"
    L["Events (Fire Festival)"]                       = "事件 (火焰節)"
    L["L70ETC Tracks"]                                = "L70ETC 曲目"
