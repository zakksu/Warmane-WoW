...
Assert-Contains $auction "EnsureAuctionatorReady" "Auction.lua waits for Blizzard_AuctionUI + Atr_Init"
Assert-Contains $auction "SearchBlizzardBrowse" "Auction.lua has Blizzard Browse fallback"
...
$harness = Join-Path $root "PhaseOne_Druid_LevelingPack\Interface\AddOns\P1DruidGuide\TestHarness.lua"
Assert-Contains $harness "\[P1TEST\]" "TestHarness structured log prefix"
Assert-Contains $harness "RunSelfTests" "TestHarness self-test runner"
