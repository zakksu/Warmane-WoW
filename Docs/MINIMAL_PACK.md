...
v1.5.0 ships a **quest-only** addon set focused on druid leveling (with v1.5 PATH + BIS icons in druid guide). No class HUDs, no range/damage clutter.
...
| Command | Action |
|---------|--------|
| `/p1` or `/p1guide` | Toggle druid guide overlay (PATH + BIS icons + min) |
