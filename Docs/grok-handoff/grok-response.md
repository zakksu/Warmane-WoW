...
## Post notes
- Update STATUS.md to GROK_DONE or per loop rules after this write. (Note: per strict query, this file + CURSOR_TASKS only were edited here.)
